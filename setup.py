...
optional_dependencies = {
    ...
    "notebooks": ["notebook", "tabulate", "ipython"],
    "visualization": ["bokeh>=1.3.4", "colorama"],
    "test": [
        "parameterized",
        "numpydoc>=0.9.1",
        "pycodestyle>=2.4.0",
        "pydocstyle==2.0.0",
        "testflo>=1.3.6" "websockets>8",
        "pyppeteer",
        "aiounittest",
    ],
}
...
setup(
    ...
    python_requires=">=3.6",
    install_requires=["networkx>=2.0", "numpy", "pyDOE2", "pyparsing", "scipy", "requests"],
    entry_points={
        "console_scripts": [
